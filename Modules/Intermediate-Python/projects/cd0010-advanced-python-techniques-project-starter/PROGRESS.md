...
| Area | Status | Notes |
|---|---|---|
| Task 1: `NearEarthObject.__init__` | Complete | Constructor logic added; remove starter markers/comments before submission. |
| Task 1: `NearEarthObject.fullname` | Complete | Should return `designation` or `designation (name)`. |
| Task 1: `NearEarthObject.__str__` | Complete | Must match README human-readable format. |
