...
You might need to Google the Python built-in functions append() and remove().
...
Call the function calculate_score().
...
If yes, use the deal_card() function to add another card to the user_cards list.
